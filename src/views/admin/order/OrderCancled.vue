...
<script>
import "../../../assets/admin/assets/js/plugin/webfont/webfont.min copy"
...
import OrderCancled from "@/components/admin/order/OrderCancledCoponent.vue";
...
export default {
    components: {
        OrderCancled, HeaderComponent, NavbarComponent, SideBarComponent
    },
}
</script>